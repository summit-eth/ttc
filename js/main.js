var CONTRACT_ADDRESS = "TTiFzEwYGK17Z5dPEjX4v6dbjmwqSQMiB3";
var SOFT_LAUNCH = 1602835200; 
var FULL_LAUNCH = 1602900000; 
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var load_obj = setInterval(async ()=>{
      if (window.tronWeb && window.tronWeb.defaultAddress.base58) {
        ...
        document.getElementById("referral_link").value = "https://trontrust.co/?r="+window.trontrust.address;
